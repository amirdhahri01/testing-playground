...
export class PasswordChecker{
    ...
    public checkPassword(password : string) : CheckResult{
        ...
        this.checkToLowerCase(password , reasons);
        this.checkToUpperCase(password , reasons);
        return {
    ...
    private checkToLowerCase = (password:string , reasons : PasswordErrors[]) => {
        if(password === password.toLowerCase()){
            reasons.push(PasswordErrors.NO_UPPER_CASE);
        }
    }
    private checkToUpperCase = (password:string , reasons : PasswordErrors[]) => {
